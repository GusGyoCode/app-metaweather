  ...
  return (
    <main className="w-full lg:w-3/4 lg:h-screen bg-morado-oscuro lg:overflow-hidden lg:overflow-y-auto pt-2 style_main__1l transition duration-300">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 max-w-screen-xl mx-auto py-8 px-4 ">
        <div className="w-full rounded-xl flex flex-wrap flex-col justify-center items-center bg-morado-azulado text-gray-400 p-2 md:p-8 lg:p-2 xl:p-4">
      ...
      <div className="max-w-screen-xl mx-auto text-white mb-4 px-4 ">
      ...
      <footer className="w-full py-4 flex flex-wrap justify-center items-center">
          <h2 className="text-gray-400 font-semibold w-full text-center">created by GusGyoCode - GusGyoCode.dev</h2>
          <div className="w-full flex justify-center items-center text-gray-300"><i className="icon-github-squared text-xl"></i>
