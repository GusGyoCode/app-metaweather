...
export default function Aside () {
  ...
  return (
    <aside className="w-full lg:w-1/4 h-screen bg-white dark:bg-morado-azulado overflow-hidden relative overflow-y-auto style_sidenavScrollbar__3m">
      <div className="flex flex-wrap w-full p-4 justify-between items-center">
        ...
        <div className="flex">
          <div className="lg:hidden">
            {
              isDark === 'dark'
                ? <button onClick={() => { setIsDark('light') }} className="bg-gray-400 text-white p-2 rounded-full hover:bg-gray-300 transition duration-500">
                  <i className="icon-sun block h-5 w-5 flex justify-center items-center"></i>
                </button>
                : <button onClick={() => { setIsDark('dark') }} className="bg-gray-400 text-white p-2 rounded-full hover:bg-gray-300 transition duration-500">
                  <i className="icon-moon block h-5 w-5 flex justify-center items-center"></i>
                </button>
            }
          </div>
          <button className="p-2 bg-gray-400 text-white rounded-full hover:bg-gray-300 transition duration-500 ml-2"><i className="icon-target block h-5 w-5 flex justify-center items-center"></i></button>
        </div>
      </div>
      ...
      <div className="text-gray-400 grid -grd-cols-1 gap-10 md:gap-20 pb-8">
        <h2 className="text-8xl md:text-9xl text-center text-gray-300 dakr:text-white">
